...
puzzle(3, 18,
[
    [1, _, _, _, _, _, _, _, _, 0, _, _, _, _, _, _, _, _],
    [_, _, _, _, 0, _, _, _, _, _, _, _, _, 0, _, _, _, _],
    [1, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 1, _, _, _, _, _, _, _, _, 0, _, _, _, _],
    [0, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 0, _, _, _, _, _, _, _, _, 0, _, _, _, _],
    [0, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 0, _, _, _, _, _, _, _, _, 1, _, _, _, _],
    [1, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 1, _, _, _, _, _, _, _, _, 1, _, _, _, _],
    [0, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 1, _, _, _, _, _, _, _, _, 0, _, _, _, _],
    [1, _, _, _, _, _, _, _, _, 1, _, _, _, _, _, _, _, _],
    [_, _, _, _, 1, _, _, _, _, _, _, _, _, 1, _, _, _, _],
